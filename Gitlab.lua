...
function Library:CreateWindow(config)
    ...
    local winStroke = new("UIStroke", {Parent = self._win, Color = Color3.fromRGB(255, 255, 255), Thickness = 1, Transparency = 0.35})
    new("UIGradient", {
        Parent = winStroke,
        Rotation = 45,
...
function Library:CreateCategory(parent, title, startOpen)
    ...
    new("UICorner", {Parent = catAccent, CornerRadius = UDim.new(1, 0)})
    new("TextLabel", {
        Parent = header,
        Text = title,
